...
public final class UseCaseRouteCatalog {
    ...
    public static List<UseCaseRoute> all() {
        return List.of(
                ...
                new UseCaseRoute("CU17", "Dar Alta persona", RequestMethod.POST, "/api/v1/people"),
                ...
                new UseCaseRoute("CU48", "Dar alta escribano", RequestMethod.POST, "/api/v1/people"),
                ...
                new UseCaseRoute("CU51", "Modificar escribano", RequestMethod.PUT, "/api/v1/people/{id}"),
                ...
                new UseCaseRoute("CU61", "Buscar persona o cliente", RequestMethod.GET, "/api/v1/people/search"),
