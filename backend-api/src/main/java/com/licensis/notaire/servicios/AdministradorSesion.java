 ...
 * usuario y sesion activas
 * actualmente, junto con el conjunto de metodos necesarios para poder acceder a
 * dicha informacion.
 *
 * @author matias
 */
public class AdministradorSesion {
    ...
    /**
     * Metodo que asigna el usuario recien loguado. Este metodo permite, al
     * administrado de sesion,
    ...
    /**
     * Metodo que permite validar un usuario que intenta loguarse al sistema. Para
     * la validacion, se
     * utiliza el nombre de usuario y contraseña indicados en la pantalla de login,
     * luego se intenta
     * obtener una instancia de usuario (almacenado en la base de datos) y
     * finalmente se verifica,
     * que en caso de existir la instancia de usuario, el nombre y la contraseña
     * coincidan.
     * </p>
     * Por
     * otro lado, cabe mencionar que la contraseña es encripada (y almacenada de esa
     * forma) en la
     * base de datos.
     *
    ...
    public DtoUsuario validarUsuario(DtoUsuario miDtoUsuario) {
        ...
        try {
            IPersistenciaJpa miJpaUsuario = AdministradorJpa.getInstancia()
    ...
    /**
     * Metodo que permite obtener la instancia (un DTO) del usuario loguado en el
     * sistema
     * actualmente (junto con la referencia hacia la instancia de Persona
     * correspondiente).
     *
     * @return miUsuario Un DTO usuario que representa el usuario loguado
     *         actualmente.
     */
