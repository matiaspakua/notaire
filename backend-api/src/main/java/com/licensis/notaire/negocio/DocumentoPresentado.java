...
public class DocumentoPresentado implements Serializable, Persistable<Integer>
{
    ...
    public boolean isNew() {
        return idDocumentoPresentado == null || idDocumentoPresentado.equals(ConstantesNegocio.ID_OBJETO_NO_VALIDO);
    }
