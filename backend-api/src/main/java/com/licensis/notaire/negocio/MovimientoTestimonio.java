...
public class MovimientoTestimonio implements Serializable, Persistable<Integer>
{
    ...
    public boolean isNew() {
        return idMovimientoTestimonio == null || idMovimientoTestimonio.equals(ConstantesNegocio.ID_OBJETO_NO_VALIDO);
    }
