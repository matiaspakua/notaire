...
public class TipoDeTramite implements Serializable, Persistable<Integer> {
    ...
    public TipoDeTramite(Integer idTipoTramite, String nombre, boolean seArchiva, boolean seInscribe,
            boolean asociaInmuebles) {
        this.idTipoTramite = idTipoTramite;
        this.nombre = nombre;
    ...
    public boolean isNew() {
        return idTipoTramite == null || idTipoTramite.equals(ConstantesNegocio.ID_OBJETO_NO_VALIDO);
    }
    ...
    public boolean equals(Object object) {
        ...
        if ((this.idTipoTramite == null && other.idTipoTramite != null)
                || (this.idTipoTramite != null && !this.idTipoTramite.equals(other.idTipoTramite))) {
            return false;
        }
        return true;
    }
