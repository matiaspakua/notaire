...
public class TipoIdentificacion implements Serializable, Persistable<Integer> {
    ...
    public boolean isNew() {
        return idTipoIdentificacion == null || idTipoIdentificacion.equals(ConstantesNegocio.ID_OBJETO_NO_VALIDO);
    }
