...
public class EstadoDeGestion implements Serializable, Persistable<Integer> {
    ...
    public boolean isNew() {
        return idEstadoGestion == null || idEstadoGestion.equals(ConstantesNegocio.ID_OBJETO_NO_VALIDO);
    }
