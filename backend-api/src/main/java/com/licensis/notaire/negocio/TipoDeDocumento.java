...
public class TipoDeDocumento implements Serializable, Persistable<Integer>
{
    ...
    public boolean isNew() {
        return idTipoDocumento == null || idTipoDocumento.equals(ConstantesNegocio.ID_OBJETO_NO_VALIDO);
    }
