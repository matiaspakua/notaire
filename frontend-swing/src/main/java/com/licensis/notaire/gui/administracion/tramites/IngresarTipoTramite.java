...
public class IngresarTipoTramite extends javax.swing.JInternalFrame
{
    ...
    private static final Logger logger = Logger.getLogger(IngresarTipoTramite.class.getName());
    ...
    private void botonAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAceptarActionPerformed
        ...
        {
            GenericDto miDtoTipoDeTramite = new GenericDto();

            miDtoTipoDeTramite.put("nombre", campoNombreTramite.getText());
            miDtoTipoDeTramite.put("seInscribe", checkRequiereInscripcion.isSelected());
            miDtoTipoDeTramite.put("seArchiva", checkBoxSeArchiva.isSelected());
            miDtoTipoDeTramite.put("asociaInmuebles", checkBoxInmueble.isSelected());
            
            String observaciones = campoObservaciones.getText();
            if (observaciones != null && !observaciones.isEmpty())
            {
                miDtoTipoDeTramite.put("observaciones", observaciones);
            }

            List<GenericDto> documentos = obtenerDocumentosSeleccionados();

            miDtoTipoDeTramite.put("habilitado", true);
            ...
            if (documentos != null && !documentos.isEmpty())
            {
                try
                {
                    ...
                    GenericDto tipoTramiteCreado = tipoTramiteClient.create(miDtoTipoDeTramite);
                    
                    // TODO: Asociar documentos al tipo de trámite
                    // Esto requerirá un endpoint específico en el backend o manejar la relación
                    // Por ahora, creamos el tipo de trámite básico
                ...
                catch (IOException ex)
                {
                    ...
                    logger.log(Level.SEVERE, "Error al dar de alta tipo de trámite", ex);
