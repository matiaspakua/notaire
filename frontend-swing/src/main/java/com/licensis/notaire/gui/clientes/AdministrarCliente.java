...
public class AdministrarCliente extends javax.swing.JInternalFrame {
    ...
    private void modificarPersona() throws NonexistentJpaException {
        ...
        try {
            ...
            String msj = AdministradorValidacionesGui.getInstancia().validarModificarPersona(this);
            ...
            JOptionPane.showMessageDialog(this, "La persona ha sido eliminada, accion cancelada", "Advertencia",
                    JOptionPane.WARNING_MESSAGE);
            this.salir();
    ...
    private void modificarCliente() throws NonexistentJpaException {
        ...
        try {
             ...
             * completos
             */
            String msj = AdministradorValidacionesGui.getInstancia().validarCliente(this);
