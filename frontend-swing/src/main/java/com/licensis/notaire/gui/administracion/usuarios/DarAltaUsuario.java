...
public class DarAltaUsuario extends javax.swing.JInternalFrame {
    ...
    {// GEN-HEADEREND:event_botonAceptarActionPerformed
         ...
         */
        String msj = AdministradorValidacionesGui.getInstancia().validarAltaUsuario(this);
        ...
        if (msj == "") {
            try {
                ...
                // Control si existe o no un usuario asignado a la persona
                if (miController.buscarUsuario(dtoUsuario) == null) {
                    // Se da de alta el usuario
                    dtoUsuario = miController.darAltaUsuario(dtoUsuario);

                    if (dtoUsuario != null) {
                        JOptionPane.showMessageDialog(this,
                                "Fue dado de alta: " + dtoUsuario.getNombre() + " " + dtoUsuario.getTipo(),
                    ...
                    JOptionPane.showMessageDialog(
                            this, "Ya existe un Usuario asigando a " + dtoPersona.getNombre() + " "
                                    + dtoPersona.getApellido() + ": " + dtoUsuario.getNombre(),
                            "Advertencia", JOptionPane.WARNING_MESSAGE);
                    this.limpiarFormulario();
                }
