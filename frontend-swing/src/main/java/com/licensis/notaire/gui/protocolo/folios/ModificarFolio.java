...
public class ModificarFolio extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        grillaDetalleFolios.getColumnModel().getSelectionModel()
        ...
        panelModificarFolioLayout.setHorizontalGroup(
                panelModificarFolioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(panelModificarFolioLayout.createSequentialGroup()
                                .addContainerGap()
                                .addGroup(panelModificarFolioLayout
                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 772,
                                                Short.MAX_VALUE)
                                        .addGroup(panelModificarFolioLayout.createSequentialGroup()
                                                .addGroup(panelModificarFolioLayout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        .addGroup(panelModificarFolioLayout.createSequentialGroup()
                                                                .addGroup(panelModificarFolioLayout.createParallelGroup(
                                                                ...
                                                                .addGroup(panelModificarFolioLayout.createParallelGroup(
                                                                        ...
                                                                        .addGroup(panelModificarFolioLayout
                                                                                ...
                                                                                .addGroup(panelModificarFolioLayout
                                                                                        ...
                                                                                        .addGroup(
                                                                                                panelModificarFolioLayout
                                                                                                        .createSequentialGroup()
                                                                                                        .addComponent(
                                                                                                                campoFoliosSeleccionado,
                                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                                                100,
                                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                                                        .addGap(18, 18,
                ...
                panelModificarFolioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(panelModificarFolioLayout.createSequentialGroup()
                                ...
                                .addGroup(panelModificarFolioLayout
                                        ...
                                        .addComponent(jLabel3)
                                        .addComponent(comboRegistroEscribano, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                        ...
                                        .addGroup(panelModificarFolioLayout.createSequentialGroup()
                                                ...
                                                .addGroup(panelModificarFolioLayout
                                                        ...
                                                        .addGroup(panelModificarFolioLayout
                                                                ...
                                                                .addComponent(jLabel2)
                                                                .addComponent(campoFoliosSeleccionado,
                                                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                .addComponent(jLabel5)
                                                                .addComponent(comboEstadosFolio,
                                                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                                                        .addComponent(botonSeleccionar,
            ...
            for (Iterator<DtoFolio> it = dtoListaFolios.iterator(); it.hasNext();) {
                ...
                if (dtoFolio.getNumero() == this.folioSeleccionado) {
                    ...
                    if (miController.modificarFolio(dtoFolio)) {
                        ...
                        JOptionPane.showMessageDialog(this, "No se ha podido modificar el folio indicado",
                                "Error al modificar folio", JOptionPane.ERROR_MESSAGE);
                    }
                }
            }
        } catch (Exception ex) {
            if (ex instanceof ClassModifiedException) {
                JOptionPane.showMessageDialog(this, "El folio que intenta modificar ha sido recientemente actualizado",
                        "Advertencia", JOptionPane.WARNING_MESSAGE);
            } else if (ex instanceof ClassEliminatedException) {
                JOptionPane.showMessageDialog(this, "El folio que intenta modificar ha sido recientemente eliminado",
                        "Advertencia", JOptionPane.WARNING_MESSAGE);
            } else if (ex instanceof NullPointerException) {
                JOptionPane.showMessageDialog(this, "No existen folios registrados o no ha seleccionado ninguno",
                        "Error",
                        JOptionPane.ERROR_MESSAGE);
            } else {
    ...
    {// GEN-HEADEREND:event_botonBuscarActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(this, "Alguno de los datos indicados no es valido", "Error",
                    JOptionPane.ERROR_MESSAGE);
        }
    ...
    {// GEN-HEADEREND:event_botonSeleccionarActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "No se ha seleccionado ningun elemento.", "Advertencia",
