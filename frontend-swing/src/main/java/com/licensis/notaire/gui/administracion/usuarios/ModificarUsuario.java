...
public class ModificarUsuario extends javax.swing.JInternalFrame {
    ...
    {// GEN-HEADEREND:event_botonGuardarActionPerformed
        String msj = AdministradorValidacionesGui.getInstancia().validarModificarUsuario(this);

        if (msj == "") {

            boolean flag = miController
                    .isPasswordCorrect(campoNuevaContrasenia.getPassword(), campoRepetirNuevaContrasenia.getPassword())
                    .getFlag();
            ...
            if (flag) {
                ...
                try
                // Esta excepcion permite controlar si la instancia fue modificada o eliminada
                // con anterioridad
                // capturando en la capa de aplicacion, la excepcion corresṕondiente
                {
                    ...
                    try // Esta excepcion es solicitada por Hibernate
                    {
                        ...
                        if (miDtoUsuario != null) {
                            ...
                            JOptionPane.showMessageDialog(this, "Error! - El nombre de Usuario Existe", "Advertencia",
