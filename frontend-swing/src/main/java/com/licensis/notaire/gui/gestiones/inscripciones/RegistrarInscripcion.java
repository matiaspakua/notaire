...
public class RegistrarInscripcion extends javax.swing.JInternalFrame {
    ...
    public Boolean cargarFormulario(DtoEscritura dtoEscritura) {
        ...
        if (escrituraSeleccionada != null) {
                ...
                if (movimientos != null && !movimientos.isEmpty()) {
                    if (movimientos.get(movimientos.size() - 1).getFechaInscripcion() != null) {
                        JOptionPane.showMessageDialog(this,
                                "<HTML>La Escritura ya se encuentra inscripta <BR>con fecha: "
                                        + movimientos.get(movimientos.size() - 1).getFechaInscripcion().toString()
                                        + " <BR>y matricula: " + escrituraSeleccionada.getMatriculaInscripcion()
                                        + "</HTML>",
                        ...
                        this.campoFolioDesde
                                .setText(new Integer(dtoEscritura.getFolios().get(0).getNumero()).toString());
                        this.campoFolioHasta.setText(new Integer(
                                dtoEscritura.getFolios().get(dtoEscritura.getFolios().size() - 1).getNumero())
                                .toString());
                        ...
                        campoNumeroCarton.setText(
                                new Integer(movimientos.get(movimientos.size() - 1).getNumeroCarton()).toString());
                        campoFechaIngreso.setText(
                                formatter.format(movimientos.get(movimientos.size() - 1).getFechaIngreso()).toString());
                    }
                } else {
                    JOptionPane.showMessageDialog(this,
            ...
            JOptionPane.showMessageDialog(this, "Error grave, Accion cancelada: La escritura no existe.", "Error",
    ...
    private void initComponents() {
        ...
        javax.swing.GroupLayout panelRegistrarInscripcionLayout = new javax.swing.GroupLayout(
                panelRegistrarInscripcion);
        ...
        panelRegistrarInscripcionLayout.setHorizontalGroup(
                panelRegistrarInscripcionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(panelRegistrarInscripcionLayout.createSequentialGroup()
                                .addContainerGap()
                                .addGroup(panelRegistrarInscripcionLayout
                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                                                panelRegistrarInscripcionLayout.createSequentialGroup()
                                                ...
                                                .addGroup(panelRegistrarInscripcionLayout
                                                        ...
                                                        .addGroup(panelRegistrarInscripcionLayout
                                                                ...
                                                                .addGroup(panelRegistrarInscripcionLayout
                                                                        ...
                                                                        .addGroup(panelRegistrarInscripcionLayout
                                                                                .createSequentialGroup()
                                                                                .addGroup(
                                                                                        panelRegistrarInscripcionLayout
                                                                                                .createParallelGroup(
                                                                                                        javax.swing.GroupLayout.Alignment.LEADING,
                                                                                                        false)
                                                                                                .addComponent(
                                                        ...
                                                        .addGroup(panelRegistrarInscripcionLayout
                                                                ...
                                                                .addGroup(panelRegistrarInscripcionLayout
                                                                        ...
                                                                        .addComponent(selectorFechaInscripcion,
                                                        ...
                                                        .addGroup(panelRegistrarInscripcionLayout
                                                                ...
                                                                .addGroup(panelRegistrarInscripcionLayout
                                                                        .createParallelGroup(
                                                                                javax.swing.GroupLayout.Alignment.LEADING)
                                                                        .addComponent(selectorFechaSalida,
                                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                Short.MAX_VALUE)
                ...
                panelRegistrarInscripcionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(panelRegistrarInscripcionLayout.createSequentialGroup()
                                ...
                                .addGroup(panelRegistrarInscripcionLayout
                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jLabel11)
                                        .addComponent(campoFechaIngreso, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(panelRegistrarInscripcionLayout
                                ...
                                .addGroup(panelRegistrarInscripcionLayout
                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(selectorFechaInscripcion, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jLabel14))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(panelRegistrarInscripcionLayout
                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jLabel15)
                                        .addComponent(campoMatricula, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(14, 14, 14)
                                .addGroup(panelRegistrarInscripcionLayout
    ...
    {// GEN-HEADEREND:event_botonAceptarActionPerformed
        if (!admin.validarCampoVacio(campoMatricula.getText())
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this,
                        "Debe completar todos los campos necesarios o ha ocurrido un error: " + ex.getMessage(),
                        "ERROR", JOptionPane.ERROR_MESSAGE);
                Logger.getLogger(RegistrarInscripcion.class.getName()).log(Level.SEVERE, null, ex);
                salir();
            }
        } else {
            JOptionPane.showMessageDialog(this, "Debe completar todos los campos necesarios.", "ADVERTENCIA",
                    JOptionPane.WARNING_MESSAGE);
        }
