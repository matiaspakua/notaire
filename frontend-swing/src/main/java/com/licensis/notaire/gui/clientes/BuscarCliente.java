...
public class BuscarCliente extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        panelBuscarClienteLayout.setHorizontalGroup(
                panelBuscarClienteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(panelBuscarClienteLayout.createSequentialGroup()
                                .addContainerGap()
                                .addGroup(panelBuscarClienteLayout
                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelBuscarClienteLayout
                                                .createSequentialGroup()
                                                .addGap(0, 0, Short.MAX_VALUE)
                                                .addComponent(botonBuscar, javax.swing.GroupLayout.PREFERRED_SIZE, 120,
                                        ...
                                        .addGroup(panelBuscarClienteLayout.createSequentialGroup()
                                                .addGroup(panelBuscarClienteLayout
                                                        ...
                                                        .addGroup(panelBuscarClienteLayout.createSequentialGroup()
                                                                .addGroup(panelBuscarClienteLayout.createParallelGroup(
        ...
        layout.setHorizontalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(panelBuscarCliente, javax.swing.GroupLayout.DEFAULT_SIZE,
    ...
    {// GEN-HEADEREND:event_botonBuscarActionPerformed
        ...
        if (buscarNombreApellido.isSelected()
            ...
            try {
                ...
                if (!campoNombre.getText().isEmpty()) {
                    qPath += "nombre=" + URLEncoder.encode(campoNombre.getText(), StandardCharsets.UTF_8);
                    first = false;
                }
                if (!campoApellido.getText().isEmpty()) {
                    qPath += (first ? "" : "&") + "apellido="
                            + URLEncoder.encode(campoApellido.getText(), StandardCharsets.UTF_8);
                }
                List<GenericDto> rawPersonas = personaClient.findAllByPath(qPath);
                if (rawPersonas != null) {
                    for (GenericDto g : rawPersonas) {
                        miListaDtoPersonasEncontradas.add(RestMapper.toDtoPersona(g));
                    }
                }
            } catch (IOException ex) {
                Logger.getLogger(BuscarCliente.class.getName()).log(Level.SEVERE, null, ex);
                miListaDtoPersonasEncontradas = null;
            }
            ...
            if (miListaDtoPersonasEncontradas != null && !miListaDtoPersonasEncontradas.isEmpty()) {
                ...
                switch (tipoBusqueda) {
                    ...
                    case ConstantesGui.MODIFICAR_CLIENTE: {
                        ...
                        this.flag = ListarPersonas.getInstancia().cargarGrillaClientes(miListaDtoPersonasEncontradas,
                                ConstantesGui.MODIFICAR_CLIENTE);
                        break;
                    }
                    case ConstantesGui.BUSCAR_CLIENTE: {
                        ListarPersonas.getInstancia().limpiarJtable();
                        this.flag = ListarPersonas.getInstancia().cargarGrillaClientes(miListaDtoPersonasEncontradas,
                                ConstantesGui.BUSCAR_CLIENTE);
                        break;
                    }
                    case ConstantesGui.DAR_ALTA_CLIENTE: {
                        ListarPersonas.getInstancia().limpiarJtable();
                        this.flag = ListarPersonas.getInstancia().cargarGrillaPersonas(miListaDtoPersonasEncontradas,
                                ConstantesGui.DAR_ALTA_CLIENTE);
                        break;
                    }
                    case ConstantesGui.MODIFICAR_PERSONA: {
                        ListarPersonas.getInstancia().limpiarJtable();
                        this.flag = ListarPersonas.getInstancia().cargarGrillaPersonasClientes(
                                miListaDtoPersonasEncontradas, ConstantesGui.MODIFICAR_PERSONA);
                        break;
                    }
                    case ConstantesGui.DAR_ALTA_USUARIO: {
                        ListarPersonasUsuario.getInstancia().limpiarJtable();
                        this.flag = ListarPersonasUsuario.getInstancia()
                                .cargarGrillaPersonasClientes(miListaDtoPersonasEncontradas);
                        break;
                    }
                    case ConstantesGui.DAR_ALTA_ESCRIBANO: {
                        ListarPersonasUsuario.getInstancia().limpiarJtable();
                        this.flag = ListarPersonasUsuario.getInstancia().cargarPersonasEscribano(
                                miListaDtoPersonasEncontradas, ConstantesGui.DAR_ALTA_ESCRIBANO);
                        break;
                    }
                    case ConstantesGui.MODIFICAR_ESCRIBANO: {
                        ListarPersonasUsuario.getInstancia().limpiarJtable();
                        this.flag = ListarPersonasUsuario.getInstancia().cargarPersonasEscribano(
                                miListaDtoPersonasEncontradas, ConstantesGui.MODIFICAR_ESCRIBANO);
                        break;
                    }
                    case ConstantesGui.CREAR_PRESUPUESTO: {
                        ...
                        this.flag = ListaPersonasPresupuesto.getInstancia()
                                .cargarGrillaPersonas(miListaDtoPersonasEncontradas);
                    ...
                    case ConstantesGui.MODIFICAR_GESTION_AGREGAR_CLIENTE: {
                        ListarPersonas.getInstancia().limpiarJtable();
                        ListarPersonas formListar = ListarPersonas.getInstancia();
                        formListar.cargarGrillaClientes(miListaDtoPersonasEncontradas,
                                ConstantesGui.MODIFICAR_GESTION_AGREGAR_CLIENTE);
                        this.salir();
                        break;
                    }
                }
            ...
            int idTipo = RestMapper.asociarFkTipoIdentificacion(comboTipoIdentificacion.getSelectedItem().toString());
            miDtoPersonaParametros.getDtoTipoIdentificacion().setIdTipoIdentificacion(idTipo);

            miDtoPersonaParametros = null;
            try {
                String path = "buscar?numeroIdentificacion="
                        + URLEncoder.encode(campoNumeroIdentificacion.getText(), StandardCharsets.UTF_8);
                if (idTipo > 0)
                    path += "&idTipoIdentificacion=" + idTipo;
                List<GenericDto> rawList = personaClient.findAllByPath(path);
                if (rawList != null && !rawList.isEmpty()) {
                    miDtoPersonaParametros = RestMapper.toDtoPersona(rawList.get(0));
                }
            } catch (IOException ex) {
                Logger.getLogger(BuscarCliente.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            if (miDtoPersonaParametros != null) {
                ...
                switch (tipoBusqueda) {
                    ...
                    case ConstantesGui.DAR_ALTA_CLIENTE:
                    case ConstantesGui.BUSCAR_CLIENTE: {
                        this.flag = AdministrarCliente.getInstancia().cargarFormulario(miDtoPersonaParametros,
                    ...
                    case ConstantesGui.INICIAR_GESTION: {
                        ...
                        JOptionPane.showMessageDialog(this, "Se ha agregado un cliente a la gestion.", "Aviso",
                ...
                JOptionPane.showMessageDialog(this, "La persona no esta Registrada", "Advertencia",
                        JOptionPane.WARNING_MESSAGE);

            }
        } else {
            JOptionPane.showMessageDialog(this, "Complete los datos de busqueda", "Advertencia",
                    JOptionPane.WARNING_MESSAGE);
        }

        if (flag) { // Si es verdadera significa que se cargo la persona deseada, cierro busqueda
            this.dispose();
        }
    ...
    public void cargarCombo() {
        try {
            List<GenericDto> rawTipos = tipoIdentificacionClient.findAll();
            if (rawTipos != null) {
                for (GenericDto rawTipo : rawTipos) {
                    DtoTipoIdentificacion miTipo = RestMapper.toDtoTipoIdentificacion(rawTipo);
