...
public class IngresarParaInscripcion extends javax.swing.JInternalFrame {
            ...
            if (movimientos != null && !movimientos.isEmpty()) {
                if (movimientos.get(movimientos.size() - 1).getFechaInscripcion() != null) {
                    ...
                    JOptionPane.showMessageDialog(this,
                            "<HTML>La Escritura ya se encuentra ingresada para inscribir<BR> con fecha: "
                                    + movimientos.get(movimientos.size() - 1).getFechaIngreso()
                                    + "<BR> y numero de carton: "
                                    + movimientos.get(movimientos.size() - 1).getNumeroCarton() + "</HTML>",
                            "ADVERTENCIA", JOptionPane.WARNING_MESSAGE);
                    cargada = false;
                }
            } else {
                                                ...
                                                .addGroup(panelRegistrarInscripcionLayout
                                                        ...
                                                        .addGroup(panelRegistrarInscripcionLayout
                                                                ...
                                                                .addGroup(panelRegistrarInscripcionLayout
                                                                        .createParallelGroup(
                                                                                javax.swing.GroupLayout.Alignment.LEADING)
                                                                        .addComponent(campoNumeroTestimonio,
                                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                115,
                                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                        .addGroup(panelRegistrarInscripcionLayout
                                                                                ...
                                                                                .addComponent(selectorFechaIngreso,
    ...
    {// GEN-HEADEREND:event_botonAceptarActionPerformed
        ...
        if (!admin.validarCampoVacio(campoNumeroCarton.getText())
            ...
            JOptionPane.showMessageDialog(this, "Debe completar al menos el Numero de Carton y Fecha de Ingreso.",
                    "ADVERTENCIA", JOptionPane.WARNING_MESSAGE);
        }
