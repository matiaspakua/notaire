...
public class IngresarConcepto extends javax.swing.JInternalFrame
{
    ...
    private void initComponents() {
        ...
        panelIngresarConceptoLayout.setHorizontalGroup(
            ...
            .addGroup(panelIngresarConceptoLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(panelIngresarConceptoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelIngresarConceptoLayout.createSequentialGroup()
                        ...
                        .addGroup(panelIngresarConceptoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(panelIngresarConceptoLayout.createSequentialGroup()
                                ...
                                .addGroup(panelIngresarConceptoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(panelIngresarConceptoLayout.createSequentialGroup()
                                        .addComponent(selectorPorcentaje, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(jLabel5))
                                    .addGroup(panelIngresarConceptoLayout.createSequentialGroup()
                                        .addGroup(panelIngresarConceptoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(campoNombreConcepto)
                                            .addComponent(campoValorConcepto, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(labelAdvertencia, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                        .addGap(0, 0, Short.MAX_VALUE))))
        );
        panelIngresarConceptoLayout.setVerticalGroup(
            ...
            .addGroup(panelIngresarConceptoLayout.createSequentialGroup()
                ...
                .addComponent(jLabel1)
                .addGap(18, 18, 18)
                .addGroup(panelIngresarConceptoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(campoNombreConcepto, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(panelIngresarConceptoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(campoValorConcepto, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(labelAdvertencia, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(panelIngresarConceptoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                    .addComponent(selectorPorcentaje, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel5))
                .addGap(18, 18, 18)
                .addGroup(panelIngresarConceptoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel6)
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(panelIngresarConcepto, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
    ...
    {//GEN-HEADEREND:event_botonAceptarActionPerformed
        ...
        if (msj == "")
        {
            try
            {
                GenericDto miDtoConcepto = new GenericDto();

                miDtoConcepto.put("nombre", this.campoNombreConcepto.getText());

                if ("".equals(this.campoValorConcepto.getText()))
                {
                    miDtoConcepto.put("valor", 0.0f);
                } else
                {
                    miDtoConcepto.put("valor", Float.valueOf(this.campoValorConcepto.getText()));
                }

                miDtoConcepto.put("habilitado", true);

                if (checkBoxFijo.isSelected())
                {
                    miDtoConcepto.put("fijo", true);
                    miDtoConcepto.put("porcentaje", 0);
                } else
                {
                    miDtoConcepto.put("fijo", false);
                    miDtoConcepto.put("porcentaje", Integer.valueOf(this.selectorPorcentaje.getValue().toString()));
                }

                conceptoClient.create(miDtoConcepto);
