...
This skill provides comprehensive guidance for AI coding agents (OpenCode, Codex, GitHub Copilot) to implement changes in the Notaire project following the mandatory development process defined in `CONSTITUTION.md`.
