...
public class ArchivarGestion extends javax.swing.JInternalFrame
{
    ...
    private void initComponents() {
        ...
        grillaGestiones.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nro Gestión", "Encabezado", "Fecha Inicio", "Estado", "Nro. Bibliorato", "Observaciones", "DtoGestion", "Archivada"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Integer.class, java.lang.String.class, java.lang.Object.class, java.lang.Boolean.class
            };
        ...
        panelArchivarGestionLayout.setHorizontalGroup(
            ...
            .addGroup(panelArchivarGestionLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(panelArchivarGestionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelArchivarGestionLayout.createSequentialGroup()
        ...
        panelArchivarGestionLayout.setVerticalGroup(
            ...
            .addGroup(panelArchivarGestionLayout.createSequentialGroup()
                ...
                .addGap(11, 11, 11)
                .addGroup(panelArchivarGestionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(panelArchivarGestion, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
    ...
    {//GEN-HEADEREND:event_botonAceptarActionPerformed
        ...
        int i = JOptionPane.showConfirmDialog(this, "¿Realmente Desea Archivar la Gestiones Indicadas?", "Confirmar Salida", JOptionPane.YES_NO_OPTION);
        if (i == 0)
        {
            try
            {
                ArrayList<DtoGestionDeEscritura> listGestionesArchivadas = (ArrayList<DtoGestionDeEscritura>) this.archivarGestion();
