...
public class RegistrarEntregaDocumentos extends javax.swing.JInternalFrame
{
    ...
    private static JMenuItem ventanaRegistrarEntregaDocumentos = new JMenuItem("Ventana Registrar Entrega de Documentos");
    ...
    public boolean cargarFormulario(DtoGestionDeEscritura dtoGestionDeEscritura) 
    {
        ...
        labelEscribano.setText(this.getDtoGestion().getPersonaEscribano().getNombre() + ", " + this.getDtoGestion().getPersonaEscribano().getApellido());
    ...
    public void cargarTramites(DtoGestionDeEscritura dtoGestion)
    {
        ...
        for (int i = 0; i < listaTramites.size(); i++)
        {
            ...
            listaDocumentosNoPresentados = (ArrayList<DtoDocumentoPresentado>) listaTramites.get(i).getListaDocumentosNoPrecentados();
        ...
        {
            JOptionPane.showConfirmDialog(this, "Erro al cargar la documentación", "Advertencia", JOptionPane.WARNING_MESSAGE);
            RegistrarEntregaDocumentos.getInstancia().dispose();
        }

    }

    public Boolean cargarGrilla(ArrayList<DtoDocumentoPresentado> listaDocumentosGestion, String tipoTramite, DtoTramite dtoTramite)
    {
    ...
    private void initComponents() {
        ...
        grillaDetalleDocumentos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tramite", "Tipo de Documento", "Dias Vencimiento", "Fecha Vencimiento (*)", "Entregado?", "DtoTramite", "DtoDocumentoPresentado"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.Object.class, java.lang.Integer.class, java.lang.Object.class, java.lang.Boolean.class, java.lang.Object.class, java.lang.Object.class
            };
        ...
        javax.swing.GroupLayout panelRegistrarEntregaDocumentosLayout = new javax.swing.GroupLayout(panelRegistrarEntregaDocumentos);
        ...
        panelRegistrarEntregaDocumentosLayout.setHorizontalGroup(
            ...
            .addGroup(panelRegistrarEntregaDocumentosLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(panelRegistrarEntregaDocumentosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelRegistrarEntregaDocumentosLayout.createSequentialGroup()
                        .addGroup(panelRegistrarEntregaDocumentosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(panelRegistrarEntregaDocumentosLayout.createSequentialGroup()
                                ...
                                .addGroup(panelRegistrarEntregaDocumentosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(labelNroGestion, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelRegistrarEntregaDocumentosLayout.createSequentialGroup()
        ...
        panelRegistrarEntregaDocumentosLayout.setVerticalGroup(
            ...
            .addGroup(panelRegistrarEntregaDocumentosLayout.createSequentialGroup()
                ...
                .addComponent(labelTitulo)
                .addGap(18, 18, 18)
                .addGroup(panelRegistrarEntregaDocumentosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(botonBuscarGestion, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(panelRegistrarEntregaDocumentosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(labelNroGestion, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panelRegistrarEntregaDocumentosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel6)
                    .addComponent(labelEncabezado, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panelRegistrarEntregaDocumentosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                ...
                .addGroup(panelRegistrarEntregaDocumentosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jLabel8)
                    .addComponent(labelEscribano, javax.swing.GroupLayout.DEFAULT_SIZE, 21, Short.MAX_VALUE))
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(panelRegistrarEntregaDocumentos, javax.swing.GroupLayout.DEFAULT_SIZE, 788, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(panelRegistrarEntregaDocumentos, javax.swing.GroupLayout.DEFAULT_SIZE, 572, Short.MAX_VALUE)
        );
    ...
    {//GEN-HEADEREND:event_botonAceptarActionPerformed
        ...
        if (i == 0)
        {
            ...
            if (flag.getFlag())
            {
                ...
                if (parcial)
                {
                    JOptionPane.showMessageDialog(this, "Toda la documentacion de Cliente fue ingresada", "Atencion", JOptionPane.INFORMATION_MESSAGE);
