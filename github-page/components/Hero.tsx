  ...
  return (
    <section id="top" className="relative min-h-screen flex items-center justify-center overflow-hidden grid-pattern">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full" style={{ background: "radial-gradient(circle, rgba(10,132,255,0.08) 0%, transparent 70%)" }} />
        <div className="absolute top-1/3 left-1/3 w-96 h-96 rounded-full blur-3xl" style={{ background: "rgba(175,82,222,0.06)" }} />
      </div>
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        ...
        <div ref={badgesRef} className="mb-8 flex justify-center gap-3 flex-wrap">
          ...
          <span className="tech-badge" style={{ background: "rgba(10,132,255,0.1)", color: "var(--ai-cyan)", border: "1px solid rgba(10,132,255,0.25)" }}>2026 → AI-Powered</span>
        </div>

        <h1 ref={titleRef} className="mb-6 leading-none" style={{ fontFamily: "var(--font-display)", fontSize: "clamp(3.5rem, 10vw, 8rem)" }}>
          <span className="block text-neutral-900" style={{ letterSpacing: "-0.03em" }}>The Story of</span>
          <span className="block grad-cyan text-glow" style={{ letterSpacing: "-0.03em" }}>Notaire</span>
        </h1>

        <p ref={subtitleRef} className="text-neutral-600 text-lg sm:text-xl max-w-2xl mx-auto leading-relaxed mb-10">
          From a Java Swing university project in 2014 to a modern,{" "}
          <span className="text-[#0A84FF] font-medium">AI-accelerated</span> microservices platform—
        ...
        <div className="flex items-center justify-center gap-6 flex-wrap">
          <a href="#origin" className="group flex items-center gap-2 px-8 py-3 rounded-full text-sm font-semibold transition-all duration-300"
            style={{ background: "linear-gradient(135deg, #0a84ff, #af52de)", color: "white" }}>
            Explore the Story
          ...
          <a href="https://github.com/matiaspakua/notaire" target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-2 px-8 py-3 rounded-full text-sm font-semibold text-neutral-700 border border-neutral-300 hover:border-neutral-400 hover:text-neutral-900 transition-all">
        ...
        {/* Scroll indicator */}
        <div className="absolute bottom-12 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-neutral-500 text-xs">
