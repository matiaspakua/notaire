export function Footer() {
  return (
    <footer className="py-12 px-6 border-t" style={{ borderColor: "rgba(255,255,255,0.06)", background: "var(--bg-dark)" }}>
      <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-white font-semibold text-sm">Notaire</div>
            <div className="text-slate-500 text-xs">2014 – 2026</div>
          </div>
        </div>
