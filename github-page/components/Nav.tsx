...
export function Nav() {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
      scrolled ? "py-3 glass border-b border-neutral-900/5 shadow-2xl" : "py-6"
    }`}>
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-1">
            ...
            <a
              ...
              className={`px-4 py-1.5 rounded-full text-sm font-medium transition-all duration-200 ${
                active === l.href.slice(1)
                  ? "bg-cyan-500/20 text-[#0A84FF] border border-cyan-500/30"
          ...
          <a
            ...
            className="ml-3 flex items-center gap-2 px-4 py-1.5 rounded-full bg-neutral-900/5 border border-neutral-900/10 text-sm text-neutral-900 hover:bg-neutral-900/10 transition-all"
          >
