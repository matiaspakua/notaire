...
public class EliminarPlantillaPresupuesto extends javax.swing.JInternalFrame
{
    ...
    private void botonAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAceptarActionPerformed
        if (miDtoSeleccionado != null)
        {
            ...
            if (respuesta == JOptionPane.YES_OPTION)
            {
                try
                {
                    Boolean eliminada = miController.eliminarPlantillaPresupuesto(plantillas);
                    ...
                    {
                        JOptionPane.showMessageDialog(this, "No se ha eliminado la plantilla de presupuesto seleccionada.", "ERROR", JOptionPane.ERROR_MESSAGE);
    ...
    private void cargarConceptosDisponibles()
    {
        ...
        if (miDtoSeleccionado != null)
        {
            ...
            {
                //Obtengo los conceptos de las plantillas del tipo de tramite
                DtoConcepto miDtoConcepto;
                String nombreConcepto;

                for (Iterator<DtoPlantillaPresupuesto> it = plantillas.iterator(); it.hasNext();)
                {
                    DtoPlantillaPresupuesto dtoPlantillaPresupuesto = it.next();
                    miDtoConcepto = dtoPlantillaPresupuesto.getConceptos();
