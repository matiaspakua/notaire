...
| **Tipo** | Primario |
| **Referencias Cruzadas** | RF #20 (Abonar trámite), RF #22 (Abonar presupuestos en cuotas); CU19, CU60; `GET /api/v1/presupuestos/{id}/resumen` (#820); `GET /api/v1/pagos/presupuesto/{id}/estado` (#821) |
| **GitHub ID** | #200 |
...
| 6 |  | Presenta: (Número de gestión; Encabezado; Número de presupuesto; Total; Saldo; Estado de pago [Sin pagos / Parcialmente abonado / Saldado]; Número de pago; Monto de pago; Fecha de pago; Observaciones) |
