...
| 4 |  | Muestra: (Número de escritura; Fecha; Folios utilizados; Nomenclaturas catastrales asociadas (si corresponde)) Y solicita: (Fecha de ingreso; Número de cartón; Observaciones) |
| 5 | El Gestor/Escribano registra: fecha en que fue ingresado para inscribir, número de cartón, junto con algunas observaciones. |  |
