...
La versión vigente, editable y versionable en texto está en:

- [`docs/200-architecture/204-diagrams/Casos de Uso/`](../../../../200-architecture/204-diagrams/Casos%20de%20Uso/)

Cada `.jpg` archivado aquí tiene su equivalente `.puml` documentado en el
[`README.md`](../../../../200-architecture/204-diagrams/Casos%20de%20Uso/README.md) de esa carpeta.
