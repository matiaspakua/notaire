...
public class DtoPersona implements DtoValido {
    ...
    public DtoPersona(String nombre, String apellido, String nacionalidad, String cuit, String sexo,
    ...
    public Boolean isValido() {
        ...
        if (this.getIdPersona() == null || this.getIdPersona() == ID_DTO_INICIALIZADO) {
            return false;
        }
        return true;
    }
