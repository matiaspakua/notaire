...
public class DarAltaPersona extends javax.swing.JInternalFrame {
                ...
                layout.setHorizontalGroup(
                                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addGroup(layout.createSequentialGroup()
                                                                .addComponent(panelDarAltaPersona,
                                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                .addGap(0, 0, Short.MAX_VALUE)));
        ...
        {// GEN-HEADEREND:event_botonAceptarActionPerformed
                ...
                if (msj == "") {
                        ...
                        int idTipo = RestMapper.asociarFkTipoIdentificacion(dtoTipoIdentificacion.getNombre());
                        boolean existe = false;
                        try {
                                String path = "buscar?numeroIdentificacion=" + URLEncoder
                                                .encode(campoNumeroIdentificacion.getText(), StandardCharsets.UTF_8);
                                if (idTipo > 0)
                                ...
                                Logger.getLogger(DarAltaPersona.class.getName()).log(Level.SEVERE, null, ex);
                                existe = true; // prevent creation on error
                        }
                        ...
                        if (!existe) {
                                try {
                                        ...
                                        GenericDto postDto = RestMapper.toGenericDto(dtoPersona);
                                        GenericDto created = personaClient.create(postDto);

                                        if (created != null) {
                                                dtoPersona.setIdPersona(created.getInt("idPersona"));
                                                JOptionPane.showMessageDialog(this,
                                                                "Fue dado de alta: " + dtoPersona.getNombre() + " "
                                                                                + dtoPersona.getApellido(),
                                                                "Informacion", JOptionPane.INFORMATION_MESSAGE);
                                                this.limpiarFormulario();

                                        } else {
                                                JOptionPane.showMessageDialog(this, "La persona No pudo darse de alta",
                                                                "Advertencia",
                                        ...
                                        Logger.getLogger(DarAltaPersona.class.getName()).log(Level.SEVERE,
                                                        "Error al dar de alta persona",
                                                        ex);
                                }

                        } else {
                                JOptionPane.showMessageDialog(this, "El numero de Documento, ya se encuetra registrado",
                                                "Advertencia",
                                                JOptionPane.WARNING_MESSAGE);
                                this.limpiarFormulario();
                        }
